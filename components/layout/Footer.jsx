    ...
    <footer className="border-t bg-background">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Support menu */}
          <div className="col-span-1">
            <h3 className="font-semibold mb-4 text-title-secondary">Support</h3>
            <ul className="space-y-2">
              <li>
                <Link href="#help" className="text-sm text-muted-foreground hover:text-highlight transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
                <Link href="#contact" className="text-sm text-muted-foreground hover:text-highlight transition-colors">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="#status" className="text-sm text-muted-foreground hover:text-highlight transition-colors">
                  Status
                </Link>
              </li>
              <li>
